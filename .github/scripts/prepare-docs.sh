...
REPO_SLUG="${GITHUB_REPOSITORY:-AMWA-TV/info-template}"
...
DOCS_URL="${DOCS_URL:-${PUBLIC_DOCS_ROOT%/}}"

# Keep Zensical's canonical links aligned with the staging URL. The
# non-versioned site is uploaded directly below this path.
python3 - "${DOCS_URL%/}/" <<'PY'
